...
public class SessionFilter implements Filter {
    ...
    private final List<Pattern> managerUrlPatterns = Arrays.asList(
            ...
            // "/manager/InterviewList"のURLパターンにマッチ
            Pattern.compile("^/manager/InterviewList$"),

            // "/manager/EditInterview/{編集id}"のURLパターンにマッチ
            Pattern.compile("^/manager/EditInterview?[^?]+$"),
            
            // "/manager/ReviewInterview/{編集id}"のURLパターンにマッチ
            Pattern.compile("^/manager/ReviewInterview?[^?]+$"),

            // "/manager/ReviewUserInterview/{編集id}"のURLパターンにマッチ
            Pattern.compile("^/manager/ReviewUserInterview?[^?]+$"),
            
            // "/manager/SearchInterview"のURLパターンにマッチ
            Pattern.compile("^/manager/SearchInterview$"),
            
            // "/manager/DelInterview/{削除id}"のURLパターンにマッチ
            Pattern.compile("^/manager/DelInterview?[^?]+$"),
            
            // "/manager/SearchUserInterview/{新規id}"のURLパターンにマッチ
            Pattern.compile("^/manager/UserInterview?[^?]+$"),

            // "/manager/SaveInterview"のURLパターンにマッチ
            Pattern.compile("^/manager/SaveInterview$"),

            // "/manager/SaveUserInterview"のURLパターンにマッチ
            Pattern.compile("^/manager/SaveUserInterview$"),
