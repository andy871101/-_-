...
public enum CommonMessage {
    ...
    INSERT_SUCCESS(1009, "登録に成功しました"),SEARCH_SUCCESS(1010, "Get data success"),
    ...
    WRONG_AGE(2019, "年齢範囲が間違っています"),WRONG_GENDER(2020,"性別設定が間違っています"),TITLE_IS_EMPTY(2021,"主旨を設定してください"),
