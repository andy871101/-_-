$(function () {
    ...
    $(".saveBtn").click(function (){
        ...
        const lifeVideoClass = document.querySelector("#lifeVideo")
        let saveData = {  
            id: idClass.value,
    ...
    $(".reviewBtn").click(function (){
        ...
        $.ajax({
            ...
            success: function(){
                ...
                // 画面更新
                $.ajax({
                    url:`/manager/ReviewUserInterview?id=${id}`,
                    type: "GET",
                    success: function(){
                        window.location.href = `/manager/ReviewUserInterview?id=${id}`;
                    }
                });
            }
        });
